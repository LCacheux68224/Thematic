...
class CreateGridAlgorithm(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        feedback.pushInfo('')
        feedback.pushInfo(self.tr('   Carroyage d\'un territoire'))  
        feedback.pushInfo("Étendue du territoire : {0}".format(layerExtent))
        feedback.pushInfo('')        
        feedback.pushInfo(self.tr('   Génération d\'une grille de carreaux'))            
        ...
        grille = processing.run("qgis:creategrid", 
                        {'TYPE':2,
                         ...
                         feedback=feedback)
        feedback.pushInfo('')                           
        feedback.pushInfo(self.tr('   Filtrage sur le territoire et ajout des identifiants'))  
    ...
    def displayName(self):
        ...
        """
        return self.tr('Generate a grid from a polygon layer')
