            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="arrowHeadLength" type="Map">
                  ...
                  <Option value="coalesce(scale_linear(abs( &quot;FLUX&quot; ), 0, 8800, 0,45288.14509100846), 0)*0.8" name="expression" type="QString"/>
                ...
                <Option name="arrowHeadType" type="Map">
                  <Option value="true" name="active" type="bool"/>
                  <Option value="case when FLUX >0 then 'single' else 'reversed' end" name="expression" type="QString"/>
                  <Option value="3" name="type" type="int"/>
                </Option>
                <Option name="arrowStartWidth" type="Map">
                  <Option value="true" name="active" type="bool"/>
                  <Option value="coalesce(scale_linear(abs( &quot;FLUX&quot; ), 0, 8800, 0,45288.14509100846), 0)" name="expression" type="QString"/>
                  <Option value="3" name="type" type="int"/>
                </Option>
