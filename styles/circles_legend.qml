    ...
    <symbols>
      <symbol force_rhr="0" name="0" clip_to_extent="1" alpha="1" type="fill">
        ...
        <layer enabled="1" locked="0" class="GeometryGenerator" pass="0">
          ...
          <prop k="geometryModifier" v=" make_line(point_n($geometry,10), make_point(x(point_n($geometry,10))+maximum(WIDTH)/1.8,y(point_n($geometry,10))))"/>
          <data_defined_properties>
            <Option type="Map">
              <Option value="" name="name" type="QString"/>
              <Option name="properties"/>
        ...
        <Option type="Map">
          ...
          <Option name="properties" type="Map">
            ...
            <Option name="PositionY" type="Map">
              <Option value="true" name="active" type="bool"/>
              <Option value="y(point_n($geometry,10))" name="expression" type="QString"/>
              <Option value="3" name="type" type="int"/>
            </Option>
          </Option>
          <Option value="collection" name="type" type="QString"/>
