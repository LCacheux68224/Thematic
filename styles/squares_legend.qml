    ...
    <symbols>
      <symbol name="0" alpha="1" force_rhr="0" clip_to_extent="1" type="fill">
        ...
        <layer enabled="1" locked="0" pass="0" class="GeometryGenerator">
          ...
          <prop k="geometryModifier" v=" make_line(point_n($geometry,3), make_point(x(point_n($geometry,3))+maximum(R)/8,y(point_n($geometry,3))))"/>
          <data_defined_properties>
            <Option type="Map">
              <Option name="name" value="" type="QString"/>
              <Option name="properties"/>
        ...
        <Option type="Map">
          ...
          <Option name="properties" type="Map">
            <Option name="PositionX" type="Map">
              ...
              <Option name="expression" value="x( point_n($geometry,3) ) +  maximum( R)/8" type="QString"/>
              <Option name="type" value="3" type="int"/>
            </Option>
            <Option name="PositionY" type="Map">
              <Option name="active" value="true" type="bool"/>
              <Option name="expression" value="y(point_n($geometry,3))" type="QString"/>
              <Option name="type" value="3" type="int"/>
            </Option>
          </Option>
          <Option name="type" value="collection" type="QString"/>
